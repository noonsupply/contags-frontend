...
export default function ProfileCreation({ navigation }) {
  ...
  const dateOfBirthNotSelectedAlert = (
    <View>
      <Text style={styles.alertMsg}>Veuillez indiquer votre date de naissance</Text>
    </View>
  );
  const phoneNumberFieldEmptyAlert = (
    <View>
      <Text style={styles.alertMsg}>Veuillez saisir un numéro de téléphone</Text>
    </View>
  );
